...
#Git Raw Location = https://raw.githubusercontent.com/codysanders7/testADW/main
...
export APPDIR=/home/opc/testADW
...
export GIT=https://raw.githubusercontent.com/codysanders7/testADW/main
...
SetupCredential()
{
   ...
   printf "Please Enter Tag Key 3 to extract as Special Tag (Oracle-Tags.Program): "; read TAG3_SPECIAL
   printf "Please Enter Tag Key 4 to extract as Special Tag (Oracle-Tags.Program): "; read TAG4_SPECIAL
...
EnableAPEXApplication()
{
   ...
   -----------------------------
   @/home/opc/testADW/usage2adw_demo_apex_app.sql
...
UpgradeApp()
{
   ...
   if [ -f "/home/opc/testADW/usage2adw.py" ]; then
      echo "   File usage2adw.py exist in app - /home/opc/testADW/usage2adw.py " | tee -a $LOG
   elif [ -f "/home/opc/oci-python-sdk/examples/testADW/usage2adw.py" ]; then
      echo "   File usage2adw.py exist in oci-python-sdk location, /home/opc/oci-python-sdk/examples/testADW/usage2adw.py" | tee -a $LOG
      echo "   Creating Symbolic Link: ln -s /home/opc/oci-python-sdk/examples/testADW ." | tee -a $LOG
      ln -s /home/opc/oci-python-sdk/examples/testADW .
   else
...
###############################################################################
0 */4 * * * timeout 6h /home/opc/testADW/shell_scripts/run_multi_daily_usage2adw.sh > /home/opc/testADW/log/run_multi_daily_usage2adw_crontab_run.txt 2>&1

###############################################################################
# Gather stats every weekend
###############################################################################
30 0   * * 0 timeout 6h /home/opc/testADW/shell_scripts/run_gather_stats.sh > /home/opc/testADW/log/run_gather_stats_run.txt 2>&1
...
SetupOL8Packages()
{
   ...
   echo "alias cdu='cd $HOME/testADW'">>$HOME/.bashrc
