...
runcmd:
  ...
  - echo "https://raw.githubusercontent.com/codysanders7/testADW/main/usage2adw_setup.sh -O $APPDIR/initial_setup.sh" > $APPDIR/initial_setup.txt
  - echo "/home/opc/testADW/initial_setup.sh -setup_full" >> $APPDIR/initial_setup.txt

  - wget https://raw.githubusercontent.com/codysanders7/testADW/main/usage2adw_setup.sh -O $APPDIR/initial_setup.sh >>$LOG
  - chown opc:opc $APPDIR/initial_setup.sh
  - chmod +x $APPDIR/initial_setup.sh
  - su - opc -c '/home/opc/testADW/initial_setup.sh -setup_full' >>$LOG
